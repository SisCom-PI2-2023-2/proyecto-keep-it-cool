...
void report() {
  ...
  resp["temperatura1"] = random(0,30);
  resp["humedad1"] = random(60,80);

  resp["temperatura2"] = random(0,30);
  resp["humedad2"] = random(60,80);

  resp["temperatura3"] = random(0,30);
  resp["humedad3"] = random(60,80);

  resp["temperatura4"] = random(0,30);
  resp["humedad4"] = random(60,80);
