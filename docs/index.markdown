...
Creando archivos `.markdown` en la carpeta principal pueden agregar "tabs" de navegación a la página. Por ejemplo [la del equipo](/docs/equipo.markdown) y [otra de prueba](/prueba)
